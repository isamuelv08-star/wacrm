...
export const SECTION_META: Record<SettingsSection, SectionMeta> = {
  ...
  multiwhatsapp: { id: 'multiwhatsapp', label: 'Multi-WhatsApp', icon: UserCog, group: 'workspace' },
  templates: { id: 'templates', label: 'Templates', icon: FileText, group: 'workspace' },
  'quick-replies': { id: 'quick-replies', label: 'Quick replies', icon: Zap, group: 'workspace' },
  fields: { id: 'fields', label: 'Fields & tags', icon: Tags, group: 'workspace' },
  deals: { id: 'deals', label: 'Deals & currency', icon: Coins, group: 'workspace' },
  products: { id: 'products', label: 'Products & quotes', icon: Package, group: 'workspace' },
  goals: { id: 'goals', label: 'Sales goals', icon: Target, group: 'workspace' },
  booking: { id: 'booking', label: 'Booking', icon: CalendarClock, group: 'workspace' },
