...
export async function PATCH(
  ...
  // Ownership check before we touch anything — scoped to the caller's
  // *current* account, not the row's original author (a former member
  // moved off this account by remove_account_member must not still be
  // able to reach it via a stale user_id match). Load the fields we
