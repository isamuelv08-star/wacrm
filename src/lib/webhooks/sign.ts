...
//
// Every delivery carries an `X-Saleslid-Signature` header so receivers
// can verify the request really came from Saleslid and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Saleslid-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Saleslid-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a Saleslid-to-Saleslid integration
